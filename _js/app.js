...
var userProfileSource = document.getElementById('user-profile-template').innerHTML,
    ...
    userPlaylistsSource = document.getElementById('user-playlists-template').innerHTML,
...
if (access_token && (state == null || state !== storedState)) {
  ...
  if (access_token) {
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        // Get list of user's playlist tracks
        $.ajax({
  ...
  spotifyApi.getUserPlaylists('nathanlouis', function(err, data){
